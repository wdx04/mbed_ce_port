...
public:
  ...
  /** The last measurement of the IAQ-calculated equivalent H2 in ppm. This
   *  value is set when you call {@link IAQmeasureRaw()} **/
  uint16_t rawH2;

  /** The last measurement of the IAQ-calculated equivalent Ethanol in ppm. This
   *  value is set when you call {@link IAQmeasureRaw()} **/
  uint16_t rawEthanol;
...
private:
  I2C *i2c_dev = nullptr; ///< Pointer to I2C bus interface
