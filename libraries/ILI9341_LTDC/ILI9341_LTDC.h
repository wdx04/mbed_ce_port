...
{
public:
  ILI9341_LTDC(PinName MOSI, PinName MISO, PinName SCK, PinName DC, PinName CS, PinName RST);

  void init(void);
  void synchronize(cv::Painter &painter);
  void invertDisplay(bool i);
  virtual void setLTDCClock();
