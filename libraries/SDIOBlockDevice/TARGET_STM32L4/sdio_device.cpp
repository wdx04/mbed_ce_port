...
const static struct DMALinkInfo SD_DMALinkInfo { 2, 5, DMA_REQUEST_7 };
...
static HAL_StatusTypeDef SD_DMAConfigRx(SD_HandleTypeDef *hsd)
{
  ...
  /* Clear DMA handle */
  stm_set_dma_handle_for_link(&SD_DMALinkInfo, nullptr);
  ...
  /* Set DMA handle */
  stm_set_dma_handle_for_link(&SD_DMALinkInfo, &hdma_rx);
...
static HAL_StatusTypeDef SD_DMAConfigTx(SD_HandleTypeDef *hsd)
{
  ...
  /* Set DMA handle */
  stm_set_dma_handle_for_link(&SD_DMALinkInfo, &hdma_tx);
